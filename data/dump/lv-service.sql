--
-- Contenu de la table `dit_service_type`
--

INSERT INTO `dit_service_type` (`id`, `srv_tp_label`) VALUES
(1, 'Découpe'),
(2, 'Intégration');

--
-- Contenu de la table `dit_service`
--

INSERT INTO `dit_service` (`id`, `dit_srv_tp_id`, `srv_label`, `srv_desc`, `srv_prix`, `srv_reduction`) VALUES
...
--
-- Contenu de la table `dit_service_option_type`
--

INSERT INTO `dit_service_option_type` (`id`, `srv_opt_tp_label`) VALUES
(1, 'Options de mise en forme'),
(2, 'Options HTML'),
(3, 'Options Javascript');

--
-- Contenu de la table `dit_service_option_valeur_type`
--

INSERT INTO `dit_service_option_valeur_type` (`id`, `srv_opt_val_tp_is_percent`, `srv_opt_val_tp_is_reduction`, `srv_opt_val_tp_is_gratuit`, `srv_opt_val_tp_val`) VALUES
(1, 1, 0, 0, 2),
(2, 0, 0, 1, 0),
(3, 0, 0, 0, 1),
(4, 0, 0, 1, 0),
...
--
-- Contenu de la table `dit_service_option`
--

INSERT INTO `dit_service_option` (`id`, `srv_opt_label`, `srv_opt_desc`, `srv_opt_type`, `srv_opt_valeur`, `dit_srv_opt_tp_id`, `dit_srv_opt_val_tp_id`) VALUES
