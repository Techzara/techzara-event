...
namespace App\Devintech\Service\UserBundle\Controller;
...
use App\Devintech\Service\UserBundle\Form\UserType;
...
//        dump($_users);die();
    ...
    public function resettingPasswordAction(Request $_request)
    {
        ...
        if ($_request->isMethod('POST')) {
            ...
            return $this->redirect($this->generateUrl('dit_resetting_password'));
        }
