...
namespace App\Devintech\Service\UserBundle\Entity;
 ...
 * Users
 *
 * @ORM\Table(name="dit_user", uniqueConstraints={@ORM\UniqueConstraint(name="username_canonical_UNIQUE", columns={"username_canonical"}), @ORM\UniqueConstraint(name="email_canonical_UNIQUE", columns={"email_canonical"}), @ORM\UniqueConstraint(name="confirmation_token_UNIQUE", columns={"confirmation_token"})})
...
class User extends BaseUser
{
     ...
     * @var DitRole
     *
     * @ORM\ManyToOne(targetEntity="App\Devintech\Service\MetierManagerBundle\Entity\DitRole")
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="dit_role_id", referencedColumnName="id")
     * })
     */
    private $ditRole;
     ...
     * @return DitRole
     */
    public function getDitRole()
    {
        return $this->ditRole;
    }

    /**
     * @param DitRole $ditRole
     */
    public function setDitRole($ditRole)
    {
        $this->ditRole = $ditRole;
    }
