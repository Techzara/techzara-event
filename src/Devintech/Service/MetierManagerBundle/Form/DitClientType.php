...
class DitClientType extends AbstractType
{
    /**
     * {@inheritdoc}
     */
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'App\Devintech\Service\MetierManagerBundle\Entity\DitClient'
        ));
    }
    ...
    {
        return 'dit_service_metiermanagerbundle_client';
    }
}
