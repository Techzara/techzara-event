...
namespace App\Devintech\Service\MetierManagerBundle\Metier\DitEmailNewsletter;
...
class ServiceMetierEmailNewsletter
{
    ...
    {
        return $this->_entity_manager->getRepository(EntityName::DIT_EMAIL_NEWSLETTER);
    }
     ...
     * @param DitEmailNewsletter $_email_newsletter
    ...
    public function insertFrontEmailNewsLetter($_email)
    {
        ...
        $_email_newsletter = new DitEmailNewsletter();
     ...
     * @return array
     */
    public function unsubscriberById(DitEmailNewsletter $_email_newsletter)
    {
