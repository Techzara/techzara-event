...
namespace App\Devintech\Service\MetierManagerBundle\Metier\DitServiceClientJointe;

use App\Devintech\Service\MetierManagerBundle\Entity\DitServiceClient;
use App\Devintech\Service\MetierManagerBundle\Entity\DitServiceClientJointe;
use App\Devintech\Service\MetierManagerBundle\Utils\EntityName;
use App\Devintech\Service\MetierManagerBundle\Utils\MaxSizeValue;
use App\Devintech\Service\MetierManagerBundle\Utils\PathName;
use App\Devintech\Service\MetierManagerBundle\Utils\Util;
use Doctrine\ORM\EntityManager;
use Symfony\Component\DependencyInjection\Container;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;

class ServiceMetierDitServiceClientJointe
{
    ...
    {
        return $this->_entity_manager->getRepository(EntityName::DIT_SERVICE_CLIENT_JOINTE);
    }
     ...
     * @return array
     */
    public function getDitServiceClientJointeById($_id)
    {
     ...
     * @return array
     */
    public function getDitServiceClientJointeByServiceClient($_id_service_client)
    {
        $_service_client_jointe = $this->getRepository()->findBy(array(
            'ditServiceClient' => $_id_service_client
        ));
     ...
     * @param DitServiceClientJointe $_service_client_jointe
     * @param string $_action
     * @return boolean
     */
    public function saveDitServiceClientJointe($_service_client_jointe, $_action)
    {
        if ($_action == 'new') {
    ...
    {
        $_service_client_jointe = new DitServiceClientJointe();
        $_service_client_jointe->setDitServiceClient($_service_client);

        if ($_fichier_projet) {
            $this->addJointe($_service_client_jointe, $_fichier_projet);
        }

        $this->saveDitServiceClientJointe($_service_client_jointe, 'new');
    }
