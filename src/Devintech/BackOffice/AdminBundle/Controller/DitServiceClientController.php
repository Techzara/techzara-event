...
use App\Devintech\Service\MetierManagerBundle\Form\DitServiceClientType;
...
/**
 * Class DitServiceClientController
 */
class DitServiceClientController extends Controller
{
    /**
    ...
    public function listAjaxAction(Request $_request, $_type)
    {
        ...
        $_template = 'AdminBundle:DitServiceClient:list.json.twig';
        if ($_type == 'not-validated')
            $_template = 'AdminBundle:DitServiceClient:list_not_validated.json.twig';
        elseif ($_type == 'validated')
            $_template = 'AdminBundle:DitServiceClient:list_validated.json.twig';

        // Récupérer les espaces
        $_nb_paris       = $_service_client_manager->getNbDitServiceClientBy($_options);
        $_product_result = $_service_client_manager->getAllDitServiceClientBy($_options, $_filters, $_sortings);
    ...
    {
        return $this->render('AdminBundle:DitServiceClient:list.html.twig');
    }
    ...
    {
        return $this->render('AdminBundle:DitServiceClient:list_not_validated.html.twig');
    }
    ...
    {
        return $this->render('AdminBundle:DitServiceClient:list_validated.html.twig');
    }
     ...
     * @return Render page
     */
    public function editAction(DitServiceClient $_service_client)
    {
        // Récupérer manager
        $_service_client_jointe_manager = $this->get(ServiceName::SRV_METIER_SERVICE_CLIENT_JOINTE);

        if (!$_service_client) {
            throw $this->createNotFoundException('Unable to find DitServiceClient entity.');
        }
        ...
        return $this->render('AdminBundle:DitServiceClient:edit.html.twig', array(
    ...
    public function newAction(Request $_request)
    {
        ...
        if ($_request->isMethod('POST')) {
            if ($_form->isSubmitted() && $_form->isValid()) {
                $_piece_jointes = $_request->files->get('dit_piece_jointe');

                // Enregistrement service_client
                $_service_client_manager->addDitServiceClient($_service_client, $_piece_jointes);
        ...
        return $this->render('AdminBundle:DitServiceClient:add.html.twig', array(
            'service_client' => $_service_client,
     ...
     * @return Render page
     */
    public function updateAction(Request $_request, DitServiceClient $_service_client)
    {
        // Récupérer manager
        $_service_client_manager = $this->get(ServiceName::SRV_METIER_SERVICE_CLIENT);
        ...
        if ($_edit_form->isSubmitted() && $_edit_form->isValid()) {
            ...
            // Enregistrement service_client
            $_service_client_manager->updateDitServiceClient($_service_client, $_piece_jointes);
     ...
     * @param DitServiceClient $_service_client The entity
     * @return \Symfony\Component\Form\Form The form
     */
    private function createCreateForm(DitServiceClient $_service_client)
    {
        $_form = $this->createForm(DitServiceClientType::class, $_service_client, array(
     ...
     * @return \Symfony\Component\Form\Form The form
     */
    private function createEditForm(DitServiceClient $_service_client)
    {
        $_form = $this->createForm(DitServiceClientType::class, $_service_client, array(
     ...
     */
    public function deleteAction(Request $_request, DitServiceClient $_service_client)
    {
        // Récupérer manager
        $_service_client_manager = $this->get(ServiceName::SRV_METIER_SERVICE_CLIENT);
        ...
        if ($_request->isMethod('GET') || ($_form->isSubmitted() && $_form->isValid())) {
            // Suppression service_client
            $_service_client_manager->deleteDitServiceClient($_service_client);
     ...
     * @param DitServiceClient $_service_client The DitServiceClient entity
     * @return \Symfony\Component\Form\Form The form
     */
    private function createDeleteForm(DitServiceClient $_service_client)
    {
    ...
    public function deleteGroupAction(Request $_request)
    {
        ...
        if ($_request->request->get('_group_delete') !== null) {
            ...
            $_service_client_manager->deleteGroupDitServiceClient($_ids);
        }
     ...
     * @return Render page
     */
    public function detailAction(Request $_request, DitServiceClient $_service_client)
    {
        // Récupérer manager
        $_service_client_manager        = $this->get(ServiceName::SRV_METIER_SERVICE_CLIENT);
        $_service_client_jointe_manager = $this->get(ServiceName::SRV_METIER_SERVICE_CLIENT_JOINTE);
        ...
        $_template = 'AdminBundle:DitServiceClient:detail.html.twig';
        if ($_user_role == RoleName::ID_ROLE_CLIENT)
            $_template = 'AdminBundle:DitServiceClient:detail_espace_membre.html.twig';
    ...
    public function updateStatusValidationAjaxAction(Request $_request)
    {
        ...
        $_service_client = $_service_client_manager->getDitServiceClientById($_id_service_client);
    ...
    public function listServiceOptionAjaxAction(Request $_request)
    {
        ...
        $_service_options = $_service_option_manager->getDitServiceOptionByService($_id_service);
    ...
    public function sendEmailConnexionClientAjaxAction(Request $_request)
    {
        ...
        $_service_client = $_service_client_manager->getDitServiceClientById($_id_service_client);
        $_user           = $_service_client->getDitUser();
    ...
    public function deleteFileAjaxAction(Request $_request) {
        ...
        $_service_client_jointe = $_service_client_jointe_manager->getDitServiceClientJointeById($_id);
